...
var ExponentialBackOffRetryPolicy = (function () {
    ...
    ExponentialBackOffRetryPolicy.ofDefaults = function () {
        return new ExponentialBackOffRetryPolicy((0, duration_1.seconds)(1), 4, (0, multiplier_1.multiplierOf)(2));
    };
...
(function (ExponentialBackOffRetryPolicy) {
    ...
    var Builder = (function () {
        ...
        Builder.prototype.build = function () {
            ...
            var multiplier = this._multiplier ? this._multiplier : (0, multiplier_1.multiplierOf)(2);
